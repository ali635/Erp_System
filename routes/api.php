...
Route::group(['prefix' => 'admin'],function (){
    ...
    Route::middleware('auth:admin-api')->group(function(){
        ...
        Route::apiResource('user','API\UserController')->middleware('can:users');
        Route::apiResource('sells','API\SellsController')->middleware('can:sells');
        Route::apiResource('purchases','API\PurchasesController')->middleware('can:purchases');
        // check supplier error
        Route::apiResource('supplier','API\SupplierController')->middleware('can:suppliers');
        Route::Post('clientreports','API\ReportsController@index')->middleware('can:clientreports');
    });
});
